...
package com.ll.myapplication.vitamio;
...
import com.ll.myapplication.vitamio.utils.ContextUtils;
import com.ll.myapplication.vitamio.utils.FileUtils;
import com.ll.myapplication.vitamio.utils.Log;
 ...
 * {@link com.ll.myapplication.vitamio.widget.VideoView}. This class will function the same as
...
public class MediaPlayer {
   ...
   *
   * @see com.ll.myapplication.vitamio.MediaPlayer.OnInfoListener
   */
   ...
   * @see com.ll.myapplication.vitamio.MediaPlayer#getTrackInfo
   */
   ...
   *         width and height is not available.
	 *         @see com.ll.myapplication.vitamio.widget.VideoView#setVideoLayout(int, float)
   */
  ...
  /**
   * @return the percent
   * @see com.ll.myapplication.vitamio.MediaPlayer.OnBufferingUpdateListener
   */
